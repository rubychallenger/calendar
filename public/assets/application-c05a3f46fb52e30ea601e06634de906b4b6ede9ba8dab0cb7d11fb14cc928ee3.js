...
(function() {
  ...
  $(function() {
    $(".highlight").click(function() {
      ...
      return $('.' + $(this).parent().parent().attr('class').split(' ').shift() + 'rec').toggleClass("shadow");
    });
    ...
    return $(".day").click(function() {
      var $this, dat1, dat2, day, month, wday, year;
      $this = $(this);
      wday = $('#wday').html();
      ...
      if ($this.hasClass('prev')) {
        if ((day - 1) !== 0) {
          ...
          $('#day').html(String(day - 1));
          $('.' + String(day - 1)).show();
          return $('.day').addClass(String(day - 1));
        } else {
          dat1 = new Date(year, month - 1, 1);
          dat1.setDate(dat1.getDate() - 1);
          return window.location.href = '/calendar?month=' + String(dat1.getMonth() + 1) + '&year=' + String(dat1.getFullYear()) + '&day=' + String(dat1.getDate());
        }
      }
    });
  });
...
(function() {
  $(function() {
    $(".btnreveal").click(function() {
      $(".loginscr").show();
      $("input[type=text], textarea").val("");
      return $("input[type=password], textarea").val("");
    });
    return $(".bod").click(function() {
      return $(".loginscr").hide();
    });
  });
